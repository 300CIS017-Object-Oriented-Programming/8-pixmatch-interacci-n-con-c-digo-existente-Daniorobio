...
![codigo](img/img_4.png)
![codigo](img/img_3.png)

#### Interfa gráfica muestra cuatro jugadores
![ej](img/img_5.png)

#### Usuario pierde el juego cuando supera un máximo posible de fallos.
![codigo](img/img_6.png)
(hay cambios en otros lados del codigo, pero esta es la funcion principal)
...
Probar el juego con diferentes casos
...
- [x] Otro (especificar: 
el codigo no corria asi que pegue el error en chatgpt para que me ayudara a identificar que estaba mal, al final resulto ser que la direccion del proyecto no estaba siendo leida bien asi que la corregi)
